...
.btn-dark2 {
  ...
  .btn-dark2:focus, .btn-dark2.focus {
    box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.15), 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 0 0.2rem rgba(23, 23, 23, 0.5); }
...
.btn-silver {
  color: #212529;
  background: #CBCBCB linear-gradient(180deg, lightgray, #CBCBCB) repeat-x;
  border-color: #CBCBCB;
  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.15), 0 1px 1px rgba(0, 0, 0, 0.075); }
  .btn-silver:hover {
    color: #212529;
...
.btn-first {
  color: #212529;
  background: #E7A703 linear-gradient(180deg, #ebb429, #E7A703) repeat-x;
  border-color: #E7A703;
  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.15), 0 1px 1px rgba(0, 0, 0, 0.075); }
  .btn-first:hover {
    color: #fff;
    background: #c18c03 linear-gradient(180deg, #ca9d29, #c18c03) repeat-x;
    border-color: #b58302; }
  .btn-first:focus, .btn-first.focus {
    box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.15), 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 0 0.2rem rgba(231, 167, 3, 0.5); }
  .btn-first.disabled, .btn-first:disabled {
    color: #212529;
    background-color: #E7A703;
    border-color: #E7A703; }
  .btn-first:not(:disabled):not(.disabled):active, .btn-first:not(:disabled):not(.disabled).active, .show > .btn-first.dropdown-toggle {
    color: #fff;
    background-color: #b58302;
    background-image: none;
    border-color: #a87a02; }
    .btn-first:not(:disabled):not(.disabled):active:focus, .btn-first:not(:disabled):not(.disabled).active:focus, .show > .btn-first.dropdown-toggle:focus {
      box-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125), 0 0 0 0.2rem rgba(231, 167, 3, 0.5); }

.btn-second {
  color: #fff;
  background: #688389 linear-gradient(180deg, #7f969b, #688389) repeat-x;
  border-color: #688389;
  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.15), 0 1px 1px rgba(0, 0, 0, 0.075); }
  .btn-second:hover {
    color: #fff;
    background: #576e73 linear-gradient(180deg, #708488, #576e73) repeat-x;
    border-color: #52676c; }
  .btn-second:focus, .btn-second.focus {
    box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.15), 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 0 0.2rem rgba(104, 131, 137, 0.5); }
  ...
  .btn-second:not(:disabled):not(.disabled):active, .btn-second:not(:disabled):not(.disabled).active, .show > .btn-second.dropdown-toggle {
    ...
    .btn-second:not(:disabled):not(.disabled):active:focus, .btn-second:not(:disabled):not(.disabled).active:focus, .show > .btn-second.dropdown-toggle:focus {
      box-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125), 0 0 0 0.2rem rgba(104, 131, 137, 0.5); }

.btn-third {
  color: #fff;
  background: #D0844F linear-gradient(180deg, #d79669, #D0844F) repeat-x;
  border-color: #D0844F;
  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.15), 0 1px 1px rgba(0, 0, 0, 0.075); }
  .btn-third:hover {
    color: #fff;
    background: #c47034 linear-gradient(180deg, #cd8552, #c47034) repeat-x;
    border-color: #ba6a32; }
  .btn-third:focus, .btn-third.focus {
    box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.15), 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 0 0.2rem rgba(208, 132, 79, 0.5); }
  ...
  .btn-third:not(:disabled):not(.disabled):active, .btn-third:not(:disabled):not(.disabled).active, .show > .btn-third.dropdown-toggle {
    ...
    .btn-third:not(:disabled):not(.disabled):active:focus, .btn-third:not(:disabled):not(.disabled).active:focus, .show > .btn-third.dropdown-toggle:focus {
      box-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125), 0 0 0 0.2rem rgba(208, 132, 79, 0.5); }

.btn-fourth {
  color: #fff;
  background: #D08441 linear-gradient(180deg, #d7965e, #D08441) repeat-x;
  border-color: #D08441;
  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.15), 0 1px 1px rgba(0, 0, 0, 0.075); }
  .btn-fourth:hover {
    color: #fff;
    background: #bc712f linear-gradient(180deg, #c6864e, #bc712f) repeat-x;
    border-color: #b26b2c; }
  .btn-fourth:focus, .btn-fourth.focus {
    box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.15), 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 0 0.2rem rgba(208, 132, 65, 0.5); }
  ...
  .btn-fourth:not(:disabled):not(.disabled):active, .btn-fourth:not(:disabled):not(.disabled).active, .show > .btn-fourth.dropdown-toggle {
    ...
    .btn-fourth:not(:disabled):not(.disabled):active:focus, .btn-fourth:not(:disabled):not(.disabled).active:focus, .show > .btn-fourth.dropdown-toggle:focus {
      box-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125), 0 0 0 0.2rem rgba(208, 132, 65, 0.5); }

.btn-money {
  color: #212529;
  background: #7ECF54 linear-gradient(180deg, #91d66e, #7ECF54) repeat-x;
  border-color: #7ECF54;
  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.15), 0 1px 1px rgba(0, 0, 0, 0.075); }
  .btn-money:hover {
    color: #212529;
    background: #68c537 linear-gradient(180deg, #7fce55, #68c537) repeat-x;
    border-color: #63bb35; }
  .btn-money:focus, .btn-money.focus {
    box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.15), 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 0 0.2rem rgba(126, 207, 84, 0.5); }
  ...
  .btn-money:not(:disabled):not(.disabled):active, .btn-money:not(:disabled):not(.disabled).active, .show > .btn-money.dropdown-toggle {
    ...
    .btn-money:not(:disabled):not(.disabled):active:focus, .btn-money:not(:disabled):not(.disabled).active:focus, .show > .btn-money.dropdown-toggle:focus {
      box-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125), 0 0 0 0.2rem rgba(126, 207, 84, 0.5); }
...
.btn-outline-first {
  ...
  .btn-outline-first:focus, .btn-outline-first.focus {
    box-shadow: 0 0 0 0.2rem rgba(231, 167, 3, 0.5); }
...
.btn-outline-second {
  ...
  .btn-outline-second:focus, .btn-outline-second.focus {
    box-shadow: 0 0 0 0.2rem rgba(104, 131, 137, 0.5); }
...
.btn-outline-third {
  ...
  .btn-outline-third:focus, .btn-outline-third.focus {
    box-shadow: 0 0 0 0.2rem rgba(208, 132, 79, 0.5); }
...
.btn-outline-fourth {
  ...
  .btn-outline-fourth:focus, .btn-outline-fourth.focus {
    box-shadow: 0 0 0 0.2rem rgba(208, 132, 65, 0.5); }
...
.btn-outline-money {
  ...
  .btn-outline-money:focus, .btn-outline-money.focus {
    box-shadow: 0 0 0 0.2rem rgba(126, 207, 84, 0.5); }
...
.badge-dark2 {
  color: #fff;
  background-color: #171717; }
  .badge-dark2[href]:hover, .badge-dark2[href]:focus {
    color: #fff;
    text-decoration: none;
    background-color: black; }
...
.badge-first {
  color: #212529;
  background-color: #E7A703; }
  .badge-first[href]:hover, .badge-first[href]:focus {
    color: #212529;
    text-decoration: none;
    background-color: #b58302; }
...
.alert-first {
  color: #785702;
  background: #faedcd linear-gradient(180deg, #fbf0d5, #faedcd) repeat-x;
  border-color: #f8e6b8; }
  .alert-first hr {
    border-top-color: #f6dea1; }
  .alert-first .alert-link {
    color: #463301; }

.alert-second {
  color: #364447;
  background: #e1e6e7 linear-gradient(180deg, #e6eaeb, #e1e6e7) repeat-x;
  border-color: #d5dcde; }
  .alert-second hr {
    border-top-color: #c7d0d3; }
  .alert-second .alert-link {
    color: #20282a; }

.alert-third {
  color: #6c4529;
  background: #f6e6dc linear-gradient(180deg, #f7eae1, #f6e6dc) repeat-x;
  border-color: #f2ddce; }
  .alert-third hr {
    border-top-color: #edcfba; }
  .alert-third .alert-link {
    color: #472d1b; }

.alert-fourth {
  color: #6c4522;
  background: #f6e6d9 linear-gradient(180deg, #f7eadf, #f6e6d9) repeat-x;
  border-color: #f2ddca; }
  .alert-fourth hr {
    border-top-color: #edd0b6; }
  .alert-fourth .alert-link {
    color: #452c16; }

.alert-money {
  color: #426c2c;
  background: #e5f5dd linear-gradient(180deg, #e9f7e2, #e5f5dd) repeat-x;
  border-color: #dbf2cf; }
  .alert-money hr {
    border-top-color: #ccedbb; }
...
.bg-first {
  background-color: #E7A703 !important; }

a.bg-first:hover, a.bg-first:focus,
button.bg-first:hover,
button.bg-first:focus {
  background-color: #b58302 !important; }

.bg-second {
  background-color: #688389 !important; }
...
.bg-third {
  background-color: #D0844F !important; }

a.bg-third:hover, a.bg-third:focus,
button.bg-third:hover,
button.bg-third:focus {
  background-color: #ba6a32 !important; }

.bg-fourth {
  background-color: #D08441 !important; }
...
.bg-gradient-silver {
  background: #CBCBCB linear-gradient(180deg, lightgray, #CBCBCB) repeat-x !important; }

.bg-gradient-red {
  background: #dc3545 linear-gradient(180deg, #e15361, #dc3545) repeat-x !important; }

.bg-gradient-first {
  background: #E7A703 linear-gradient(180deg, #ebb429, #E7A703) repeat-x !important; }

.bg-gradient-second {
  background: #688389 linear-gradient(180deg, #7f969b, #688389) repeat-x !important; }

.bg-gradient-third {
  background: #D0844F linear-gradient(180deg, #d79669, #D0844F) repeat-x !important; }

.bg-gradient-fourth {
  background: #D08441 linear-gradient(180deg, #d7965e, #D08441) repeat-x !important; }

.bg-gradient-money {
  background: #7ECF54 linear-gradient(180deg, #91d66e, #7ECF54) repeat-x !important; }
...
.border-first {
  border-color: #E7A703 !important; }

.border-second {
  border-color: #688389 !important; }

.border-third {
  border-color: #D0844F !important; }

.border-fourth {
  border-color: #D08441 !important; }

.border-money {
  border-color: #7ECF54 !important; }
