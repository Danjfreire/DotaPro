...
.btn {
  ...
  .btn:not(:disabled):not(.disabled):active, .btn:not(:disabled):not(.disabled).active {
    ...
    .btn:not(:disabled):not(.disabled):active:focus, .btn:not(:disabled):not(.disabled).active:focus {
      box-shadow: 0 0 0 0.2rem rgba(255, 0, 0, 0.25), inset 0 3px 5px rgba(0, 0, 0, 0.125); }
...
.btn-primary {
  ...
  .btn-primary:hover {
    color: #fff;
    background: #d90000 linear-gradient(180deg, #df2626, #d90000) repeat-x;
    border-color: #cc0000; }
...
.custom-range {
  ...
  .custom-range::-webkit-slider-thumb {
    ...
    .custom-range::-webkit-slider-thumb:active {
      background: #ffb3b3 linear-gradient(180deg, #ffbebe, #ffb3b3) repeat-x; }
